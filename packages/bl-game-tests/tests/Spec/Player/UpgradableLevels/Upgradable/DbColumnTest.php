...
namespace Bl\Game\Tests\Spec\Player\UpgradableLevels\Upgradable;
...
final class DbColumnTest extends TestCase
{
    ...
    public static function dbColumnProvider(): \Iterator
    {
        yield [
            ...
            'expectedColumn' => 'coeur',
        ];
        yield [
            'upgradable' => Upgradable::Mouth,
            'expectedColumn' => 'bouche',
        ];
        yield [
            'upgradable' => Upgradable::Tongue,
            'expectedColumn' => 'langue',
        ];
        yield [
