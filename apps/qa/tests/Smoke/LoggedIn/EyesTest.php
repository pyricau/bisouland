...
#[CoversNothing]
#[Large]
final class EyesTest extends TestCase
{
    #[TestDox('it blocks eyes page (`/yeux.html`) for visitors')]
    public function test_it_blocks_eyes_page_for_visitors(): void
    {
        $httpClient = TestKernelSingleton::get()->httpClient();

        $response = $httpClient->request('GET', '/yeux.html');

        Assert::blocksPageForLoggedOutVisitors($response);
    }

    #[TestDox('it loads eyes page (`/yeux.html`) for logged in players')]
    public function test_it_loads_eyes_page_for_logged_in_players(): void
    {
        $httpClient = TestKernelSingleton::get()->httpClient();
