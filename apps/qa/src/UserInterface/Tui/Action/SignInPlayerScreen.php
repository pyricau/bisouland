...
namespace Bl\Qa\UserInterface\Tui\Action;
...
#[AutoconfigureTag('app.tui_action_screen')]
final class SignInPlayerScreen implements Screen
{
    ...
    public function handle(Event $event): Action
    {
        ...
        $response = $this->qalinHttpClient->request('POST', 'api/v1/actions/sign-in-player', [
            'json' => [
