...
namespace Bl\Qa\Tests\Qalin\Integration\UserInterface\Cli\Scenario;
...
#[CoversNothing]
#[Medium]
final class SignInNewPlayerCommandTest extends TestCase
{
    public function test_it_signs_up_and_signs_in_a_new_player(): void
    {
        ...
        $application->run([
            'command' => 'scenario:sign-in-new-player',
    ...
    public static function requiredArgumentsProvider(): \Iterator
    {
        yield [
            ...
            'input' => ['command' => 'scenario:sign-in-new-player', 'password' => PasswordPlainFixture::makeString()],
            'expectedOutput' => '/missing.*username/',
        ];
        yield [
            'scenario' => 'password as a required argument',
            'input' => ['command' => 'scenario:sign-in-new-player', 'username' => UsernameFixture::makeString()],
    ...
    public static function invalidInputProvider(): \Iterator
    {
        yield [
            ...
            'input' => ['command' => 'scenario:sign-in-new-player', 'username' => 'usr', 'password' => PasswordPlainFixture::makeString()],
        ];
        yield [
            'scenario' => 'invalid password',
            'input' => ['command' => 'scenario:sign-in-new-player', 'username' => UsernameFixture::makeString(), 'password' => 'short'],
        ];
    }
}
