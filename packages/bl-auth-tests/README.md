# BisouLand - Auth Tests

Tests and Fixtures for the `bl/auth` package ("library under test").
...
The QA apps will also use this package to run its tests.
...
(e.g. `makeString()`) returning a raw value.
